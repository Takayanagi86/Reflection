                    ...
                    <div class="art-bg">                   
                        <div class="<?php echo strtolower($category[0]); ?>-block">
                            <div class="art-box">
                                ...
                                <div class="img-container">
                                    <img class="img" src="<?php echo $image[0]; ?>" alt="netmatters hiring">
                            ...
                            <div class="art-container">
                                ...
                                <div class="posted-section">
                                    ...
                                    <div class="posted-name">
                                        ...
                                        <p class="posted-p-date"><?php echo $datePosted[0]; ?></p>
                                    </div><!-- posted-name -->
                                </div><!-- posted-section -->
                            </div><!-- art-container -->
                        </div><!-- category block -->
                            ...
                            <div class="art-container">
                                ...
                                <div class="posted-section">
                                    ...
                                    <div class="posted-name">
                                        ...
                                        <p class="posted-p-date"><?php echo $datePosted[1]; ?></p>
                                    </div><!-- posted-name -->
                                </div><!-- posted-section -->
                            </div><!-- art-container -->
                        </div><!-- category block -->
                        <div class="<?php echo strtolower($category[2]); ?>-block">
                            <div class="art-box">
                                ...
                                <div class="img-container">
                                    <img class="img" src="<?php echo $image[2]; ?>" alt="kayleigh">
                                    <div class="photo-overlay"></div>
                                </div><!-- img-container -->
                            </div><!-- art-box -->
                            <div class="art-container">
                                ...
                                <div class="posted-section">
                                    ...
                                    <div class="posted-name">
                                        ...
                                        <p class="posted-p-date"><?php echo $datePosted[2]; ?></p>
                                    </div><!-- posted-name -->
                                </div><!-- posted-section -->
                            </div><!-- art-container -->
                        </div><!-- category block -->
