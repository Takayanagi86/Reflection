...
<div class="contact-form-container">
    <div class="contact-details-container">
        ...
        <div class="more-info-container">
            <div class="label more-info-btn">Out of Hours IT Support</div>
    ...
    <div class="form-container">
        <div class="form">
            <form method="POST" action="contactPost.php" accept-charset="UTF-8" novalidate="novalidate" id="contact-form"> 
                <div class="row">
                    <div class="input-container">
                        <label class="label" for="name">Your Name </label>
                        <input class="input" name="name" autocomplete="on" type="text" id="name" value="">
                    </div><!-- name container -->
                    <div class="input-container">
                        <label class="label" for="email">Your Email </label>
                        <input class="input" name="email" autocomplete="on" type="text" id="email" value="">
                    </div><!-- email container -->
                </div><!-- row -->
                <div class="row">
                    <div class="input-container">
                        <label class="label" for="number">Your Telephone Number </label>
                        <input class="input" name="number" autocomplete="on" type="text" id="number" value="">
                    </div><!-- number container -->
                    <div class="input-container">
                        <label class="label" for="subject">Subject </label>
                        <input class="input" name="subject" autocomplete="on" type="text" id="subject" value="">
                    </div><!-- subject container -->
                </div><!-- row container -->
                <div class="message-container">
                    <label class="label" for="message">Message </label>
                    <textarea class="input" name="message" id="message" class="message" cols="50" rows="10"></textarea>
                ...
                <div class="submit-btn-container">   
                    <button type="submit" id="submit" class="btn submit-btn">SEND ENQUIRY</button>
